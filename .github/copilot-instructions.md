...
| File | Lines | Contents |
|---|---|---|
| `03-MetricsHashKey.ps1` | ~117 | `$script:AppVersion` (currently `2.10.6`), metrics hash key persistence, `Get-HashedDomain`, `Handle-MetricsRequest` |
