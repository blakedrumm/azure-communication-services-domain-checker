...
**🚀 Deployment Triggers:**
- ✅ Automatically when a version tag is pushed (e.g., `v2.0.88`)
...
2. ▶️ Click **Run workflow**
3. 📝 Enter the version (e.g., `2.0.88`) or leave empty to extract from `acs-domain-checker.ps1`
4. 🚀 Click **Run workflow**
...
docker pull limitlessworlds/acs-domain-checker:2.0.88

# Pull platform-specific image
docker pull limitlessworlds/acs-domain-checker:linux-2.0.88
docker pull limitlessworlds/acs-domain-checker:windows-2.0.88
```
...
./acs-domain-checker-dockerhub.ps1 -Version 2.0.88
```
