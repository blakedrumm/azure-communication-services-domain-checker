...
const INTAKE_TEMPLATE_HTML = [
  ...
  '</ul></li>',
  '<li>' + INTAKE_ATTACHMENT_SIZE_PROMPT + '&nbsp;</li>',
...
const INTAKE_REQUEST_TEMPLATE = [
  ...
  { id: 'attachmentSizeMb',     label: INTAKE_ATTACHMENT_SIZE_PROMPT },
